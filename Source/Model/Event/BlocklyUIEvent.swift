 ...
 */
@objc(BKYUIEvent)
public final class BlocklyUIEvent: BlocklyEvent {

  // MARK: - Constants

  /// Possible elements that can be associated with a `BlocklyUIEvent`.
  @objc(BKYUIEventElement)
  ...
  /// The event type for `BlocklyUIEvent` objects.
                       ...
                       oldValue: String? = nil, newValue: String? = nil)
  {
    ...
    super.init(type: BlocklyUIEvent.EVENT_TYPE, workspaceID: workspace.uuid, groupID: nil,
               blockID: block?.uuid)
  ...
  /**
   Constructs a `BlocklyUIEvent` from the JSON serialized representation.

   - parameter json: The serialized `BlocklyUIEvent`.
   - throws:
  ...
  public required init(json: [String: Any]) throws {
    ...
    try super.init(type: BlocklyUIEvent.EVENT_TYPE, json: json)
  ...
  /**
   Creates a `BlocklyUIEvent` reflecting when a block has been clicked, inside a given workspace.

   - parameter workspace: The workspace containing the block.
   - parameter block: The block that was clicked.
   - returns: The new `BlocklyUIEvent`.
   */
  public static func blockClickedEvent(workspace: Workspace, block: Block) -> BlocklyUIEvent {
    return BlocklyUIEvent(element: .click, workspace: workspace, block: block)
  }

  /**
   Creates a `BlocklyUIEvent` reflecting the change of a block's selected state, inside a given
   workspace.
  ...
  public static func blockSelectedEvent(workspace: Workspace, block: Block, selectedBefore: Bool,
                                        selectedAfter: Bool) -> BlocklyUIEvent
  {
    return BlocklyUIEvent(element: .selected, workspace: workspace, block: block,
                          oldValue: selectedBefore ? "true" : "false",
                          newValue: selectedAfter ? "true" : "false")
  }

  /**
   Creates a `BlocklyUIEvent` reflecting the change of a block's warning message visibility,
  ...
  public static func blockWarningEvent(
    workspace: Workspace, block: Block, openedBefore: Bool, openedAfter: Bool) -> BlocklyUIEvent
  {
    return BlocklyUIEvent(element: .warningOpen, workspace: workspace, block: block,
                          oldValue: openedBefore ? "true" : "false",
                          newValue: openedAfter ? "true" : "false")
  }
  
  /**
   Creates a `BlocklyUIEvent` reflecting the change of a block comment's visibility, inside
   a given workspace.
  ...
  public static func commentEvent(
    workspace: Workspace, block: Block, openedBefore: Bool, openedAfter: Bool) -> BlocklyUIEvent
  {
    return BlocklyUIEvent(element: .commentOpen, workspace: workspace, block: block,
                          oldValue: openedBefore ? "true" : "false",
                          newValue: openedAfter ? "true" : "false")
  }

  /**
   Creates a `BlocklyUIEvent` reflecting the change of a block's mutator popover's visibility,
   inside a given workspace.
  ...
  public static func mutatorPopoverEvent(
    workspace: Workspace, block: Block, openedBefore: Bool, openedAfter: Bool) -> BlocklyUIEvent
  {
    return BlocklyUIEvent(element: .mutatorOpen, workspace: workspace, block: block,
                          oldValue: openedBefore ? "true" : "false",
                          newValue: openedAfter ? "true" : "false")
  }

  /**
   Creates a `BlocklyUIEvent` reflecting the currently open toolbox category.

   - parameter workspace: The workspace of the toolbox category.
   - parameter oldValue: The previous category that was open.
   - parameter newValue: The current category that is open.
   - returns: The new `BlocklyUIEvent`.
   */
  public static func toolboxCategoryEvent(
    workspace: Workspace, oldValue: String?, newValue: String?) -> BlocklyUIEvent
  {
    return BlocklyUIEvent(
