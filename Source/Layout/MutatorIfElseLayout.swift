...
public class MutatorIfElseLayout : MutatorLayout {
  ...
  public var elseCount: Int {
    get { return mutatorIfElse.elseCount }
    set { mutatorIfElse.elseCount = newValue }
  }
  ...
  public override func performLayout(includeChildren: Bool) {
    ...
    self.contentSize = WorkspaceSize(width: 32, height: 40)
  }
  ...
  public override func performMutation() throws {
    ...
    Layout.animate {
      layoutCoordinator.blockBumper.bumpNeighbors(ofBlockLayout: blockLayout)
    }
  }
