...
open class LayoutConfig: NSObject {
  ...
  /// [`UIColor`] The default color for text in fields.
  public static let FieldTextColor = LayoutConfig.newPropertyKey()

  /// [`UIColor`] The default color for text input in fields.
  public static let FieldInputTextColor = LayoutConfig.newPropertyKey()
  ...
  public override init() {
    ...
    setColor(.black, for: LayoutConfig.FieldTextColor)
    setColor(.black, for: LayoutConfig.FieldInputTextColor)
