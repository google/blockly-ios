...
public final class TrashCanView: UIView {
  ...
  /**
   ...
   - Parameter highlighted: Specifies if the trash can should be highlighted (`true`) or if it
   should not be highlighted (`false).
   - Parameter animated: Specifies if the highlight change should be animated (`true`) or
