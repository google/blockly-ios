 ...
 */
public protocol IntegerIncrementerViewDelegate: class {
 ...
 */
public class IntegerIncrementerView: UIView {
  ...
  public weak var delegate: IntegerIncrementerViewDelegate?
  ...
  public lazy var buttonMinus: UIButton = {
  ...
  public lazy var buttonPlus: UIButton = {
