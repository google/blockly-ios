...
CodeGeneratorBridge.requestCodeForWorkspace = function(workspaceXML, generator) {
  window.setTimeout(CodeGeneratorBridge.generateCodeForWorkspace, 0, workspaceXML, generator);
}
