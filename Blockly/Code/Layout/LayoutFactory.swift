...
public protocol LayoutFactory: class {
  /**
   ...
   - Throws:
   `BlocklyError`: Thrown if no suitable `BlockLayout` could be found for the `field`.
   */
  ...
  /**
   ...
   - Throws:
   `BlocklyError`: Thrown if no suitable `BlockGroupLayout` could be found for the `field`.
   */
  ...
  /**
   ...
   - Throws:
   `BlocklyError`: Thrown if no suitable `InputLayout` could be found for the `field`.
   */
