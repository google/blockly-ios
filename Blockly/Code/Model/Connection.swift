...
public final class Connection : NSObject {
  ...
  public struct CheckResult: OptionSetType {
    ...
    public func intersectsWith(value: Value) -> Bool {
      return intersectsWith(CheckResult(value: value))
    }
    public mutating func unionInPlace(value: Value) {
      unionInPlace(CheckResult(value: value))
    }

    func errorMessage() -> String? {
      guard !intersectsWith(Value.CanConnect) else {
        return nil
      }
  ...
  */
  public func canConnectTo(target: Connection) -> Bool {
    return canConnectWithReasonTo(target).intersectsWith(.CanConnect)
  }
