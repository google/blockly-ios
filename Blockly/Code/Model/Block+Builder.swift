...
extension Block {
  ...
  public class Builder: NSObject {
    ...
    /// Specifies the output type checks. Defaults to `[String]?`
    ...
    /// Specifies the next connection type checks. Defaults to `[String]?`
    ...
    /// Specifies the previous connection type checks. Defaults to `[String]?`.
    ...
    */
    ...
    /**
     ...
     - Throws:
     `BlocklyError`: Occurs if the builder already has a next or previous outlet.
     */
    ...
    /**
     ...
     - Throws:
     `BlocklyError`: Occurs if the builder already has an output outlet.
     */
