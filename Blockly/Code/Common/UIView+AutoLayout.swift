...
extension UIView {
  ...
  */
  ...
  /**
   ...
   `.CurveEaseInOut`.
   - Parameter updateConstraints: A closure containing the changes to commit to the view (which is
  ...
  internal func bky_updateConstraints(
    ...
    options: UIViewAnimationOptions = .CurveEaseInOut, updateConstraints: () -> Void,
