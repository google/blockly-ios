...
extension Array where Element: AnyObject {
  ...
  */
  public mutating func bky_removeAllOccurrencesOfElement(_ element: Element) {
   ...
   */
  public mutating func bky_removeFirstOccurrenceOfElement(_ element: Element) -> Bool {
