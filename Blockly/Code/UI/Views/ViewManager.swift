...
public class ViewManager: NSObject {
  ...
  public override init() {
    ...
    registerFieldViewType(FieldAngleView.self, forFieldType: FieldAngle.self)
    registerFieldViewType(FieldCheckboxView.self, forFieldType: FieldCheckbox.self)
    registerFieldViewType(FieldColourView.self, forFieldType: FieldColour.self)
    registerFieldViewType(FieldDateView.self, forFieldType: FieldDate.self)
    registerFieldViewType(FieldDropdownView.self, forFieldType: FieldDropdown.self)
    registerFieldViewType(FieldImageView.self, forFieldType: FieldImage.self)
    registerFieldViewType(FieldInputView.self, forFieldType: FieldInput.self)
    registerFieldViewType(FieldLabelView.self, forFieldType: FieldLabel.self)
  }
  ...
  */
   ...
   */
  public func registerFieldViewType<LayoutView where LayoutView: FieldView, LayoutView: Recyclable>
    (viewType: LayoutView.Type, forFieldType fieldType: Field.Type)
  {
  ...
  /**
   ...
   - Parameter fieldType: The `Field.Type` key
   */
  public func unregisterFieldViewTypeForFieldType(fieldType: Field.Type) {
