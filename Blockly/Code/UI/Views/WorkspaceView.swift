...
open class WorkspaceView: LayoutView {
  ...
  */
  ...
  /// Coder initializer for workapce view. NOTE: This is unsupported.
...
extension WorkspaceView {
  ...
  open class ScrollView: UIScrollView, UIGestureRecognizerDelegate {
    ...
    /**
     Initializer for the workspace view.

     - Parameter frame: The for the workspace view.
     */
    ...
    /// Coder initializer for workspace view. NOTE: This is currently unsupported.
    public required init?(coder aDecoder: NSCoder) {
      fatalError("Called unsupported initializer")
    }
  }
