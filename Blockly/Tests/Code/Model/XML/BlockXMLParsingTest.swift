...
class BlockXMLParsingTest: XCTestCase {
  ...
  func testLoadBlockTreeFromXML() {
    let factory = try! BlockFactory(jsonPath: "block_xml_parsing_test",
  ...
  func parseBlockFromXML(xmlString: String, _ factory: BlockFactory) -> Block.BlockTree? {
    do {
      return try Block.blockTreeFromXMLString(xmlString, factory: factory)
    } catch let error as NSError {
      bky_print("What happened?: \(error)")
    }
