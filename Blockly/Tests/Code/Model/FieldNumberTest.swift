...
class FieldNumberTest: XCTestCase {
  ...
  //  func testSetFromString_ExponentNotation() {
  //  let MIN = FieldNumber.NO_MINIMUM
  //  let MAX = FieldNumber.NO_MAXIMUM
  //  let PRECISION = FieldNumber.NO_PRECISION
  //  try fieldNumber.setConstraints(minimum: MIN, maximum: MAX, precision: PRECISION)
  //
  //  fieldNumber.setFromString("123e4")
  //  XCTAssertEqual(1230000d, fieldNumber.value)
  //
  //  fieldNumber.setFromString("1.23e4")
  //  XCTAssertEqual(12300d, fieldNumber.value)
  //
  //  fieldNumber.setFromString("-1.23e4")
  //  XCTAssertEqual(-12300d, fieldNumber.value)
  //
  //  fieldNumber.setFromString("123e-4")
  //  XCTAssertEqual(0.0123, fieldNumber.value)
  //
  //  fieldNumber.setFromString("1.23e-4")
