...
class BlockGroupLayoutTest: XCTestCase {
  ...
  func testAppendBlockLayoutsEmpty() {
    ...
    // Insert nothing
    blockGroupLayout.append(blockLayouts: [])
  ...
  func testAppendBlockLayoutsNonEmpty() {
    ...
    blockGroupLayout.append(blockLayouts: blockLayouts)
  ...
  func testRemoveBlockLayoutAtIndexFromBeginning() {
    ...
    let blockLayout = blockGroupLayout.removeBlockLayoutAt(index: 0)
  ...
  func testRemoveBlockLayoutAtIndexFromMiddle() {
    ...
    // Remove block layout from beginning
    let blockLayout = blockGroupLayout.removeBlockLayoutAt(index: 5)
  ...
  func testRemoveBlockLayoutAtIndexFromEnd() {
    ...
    // Remove block layout from beginning
    let blockLayout = blockGroupLayout.removeBlockLayoutAt(index: 9)
  ...
  func testRemoveAllStartingFromBlockLayoutInGroup() {
    ...
    let removedBlockLayouts = blockGroupLayout.removeAllStartingFrom(blockLayout: blockLayout)
  ...
  func testRemoveAllStartingFromBlockLayoutNotInGroup() {
    ...
    let removedBlockLayouts = blockGroupLayout.removeAllStartingFrom(blockLayout: randomBlockLayout)
